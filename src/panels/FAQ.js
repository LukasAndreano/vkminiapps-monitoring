	...
	render() {
		...
		<Panel id={id}>
			...
			<Group>
			    ...
			    <Div>
				  <Button size="l" onClick={this.props.clickOnLink} stretched mode="secondary" href="https://vk.me/darkflamept" target = "_blank">Написать админу</Button>
					<Button size="l" onClick={this.props.clickOnLink} style={{marginTop: 10}} stretched mode="secondary" href="https://vk.com/ow.arcade" target = "_blank">Открыть сообщество</Button>
				</Div>
			</Group>
		</Panel>
		)
